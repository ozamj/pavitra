...
- Light theme conversion (2026-08-20): navbar is now light sand glass (logo sits directly, no halo patch); footer light sand; Mission golden path, Bharat Vikas cards, Impact Philosophy staircase, Join accordion, Media & Press, Product Philosophy all converted from dark to light (#FAF7F2/#F5ECD9, ink text, antique gold #775A19 titles, purple #522B6A accents). Dark kept only for page heroes, marquee ribbon, and the closing PageCTA as signature contrast moments.
