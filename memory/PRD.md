...
- Tone rebalance (2026-08-20): menu fonts enlarged (text-xs/sm) and darkened (#261242/#180F2C); all 6 page heroes converted to light sand with antique-gold kinetic headlines (#775A19, italics #B08D1E); closing PageCTA now light sand with purple button; footer is the one dark section (deep purple #180F2C, gold gradient hairline, logo with soft halo); soft gradient shade transitions added between consecutive sections on every page. Marquee ribbon stays purple.
