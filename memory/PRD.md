...
- Main menu rebuilt (2026-08-20) per user spec: Our Sankalp / What We Do / Impact / Join The Movement (gold accent) / Newsroom / Shop / Login / Language (EN + हिन्दी "soon" dropdown). Newsroom → Shopify home, Shop → Shopify #products, Login → Shopify /account. Menu shows on lg+; mobile shows logo + Join pill only (mobile drawer still backlog).
