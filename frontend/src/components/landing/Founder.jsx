  ...
  >
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-8 lg:px-16">
      ...
      <div className="mt-12 grid lg:grid-cols-12 gap-14 lg:gap-16 items-center">
        ...
        >
          <div className="relative rounded-t-[9rem] rounded-b-2xl overflow-hidden border border-[#8C3218]/15 shadow-[0_32px_64px_-24px_rgba(140,50,24,0.35)]">
            <img
              src={FOUNDER_IMG}
        ...
        <div className="lg:col-span-8 order-1 lg:order-2">
          ...
          >
            A Message from{" "}
            <span className="italic text-[#8C3218]">the Founder</span>
          </motion.h2>
          ...
          <motion.blockquote
            ...
            className="relative mt-10 pl-8 sm:pl-12 border-l-2 border-[#B45309]/50"
            data-testid="founder-quote"
          >
            <Quote
              size={34}
              className="absolute -left-4 -top-4 text-[#D97706] fill-[#D97706]/15"
            />
          ...
          >
            <button
              className="group inline-flex items-center gap-3 border border-[#8C3218]/40 hover:bg-[#8C3218] text-[#8C3218] hover:text-[#FAF7F2] font-mono-x text-[11px] sm:text-xs tracking-[0.2em] uppercase px-6 py-3.5 rounded-full transition-colors duration-400"
      ...
      <div className="mt-20 lg:mt-28">
        <motion.p
          ...
          className="font-mono-x text-xs sm:text-sm tracking-[0.3em] uppercase text-[#8C3218] text-center"
          ...
          {PS.map((p, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="group bg-white border border-[#8C3218]/12 hover:border-[#8C3218]/35 rounded-2xl p-7 sm:p-8 text-center shadow-[0_16px_40px_-24px_rgba(140,50,24,0.3)] transition-colors duration-500"
                data-testid={`three-p-${p.title.toLowerCase()}`}
              >
                <div className="mx-auto w-14 h-14 rounded-full bg-[#8C3218]/10 border border-[#8C3218]/20 flex items-center justify-center transition-transform duration-500 group-hover:scale-110">
                  <Icon size={22} className="text-[#8C3218]" />
                </div>
