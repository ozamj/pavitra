...
const HomeThought = () => (
  ...
  >
    <div className="max-w-4xl mx-auto px-4 sm:px-8 text-center">
      ...
      >
        A Pure Thought for{" "}
        <span className="italic text-[#775A19]">Bharat</span>
      </motion.h2>
      ...
      >
        Pavitra was born from one belief — when intention is pure, business,
        service, people, and progress can come together for the upliftment of
        Bharat.
      </motion.p>
    </div>
        ...
        <div className="relative grid md:grid-cols-3 gap-6 p-6 sm:p-10 lg:p-14">
          {PILLARS.map((pillar, i) => (
            <motion.article
              ...
              data-testid={`pillar-card-${pillar.title.toLowerCase()}`}
            >
